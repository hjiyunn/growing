...
public class LoginDao {
    public static void main(String[] args) throws Exception {
        ...
        h2db.initDatabase(args);
        
        LoginDao loginTest = new LoginDao();
        
        int test2 = loginTest.insertUser();
        boolean test = loginTest.loginCheck("root", "dbswlgj29");
    ...
    public int insertUser() throws Exception {
        ...
        sql = "insert into member_test (id, password) values ('root', 'dbswlgj29');";
